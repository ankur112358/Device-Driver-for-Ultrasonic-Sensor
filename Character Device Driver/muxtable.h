...
//////structure for internal config for setting up pins
...
//////structure for defining the mux table
...
/////structure for defining the values of mux table
...
/////function to return the used pins. this function is used when we need to free the gpio pins
...
/////this function checks if the entered are valid as in available in mux table and and can be used as interrupts
...
////this function returns the value of pins
